...
export class ItemFormComponent implements OnInit {
  ...
  public includeImageInItem(event: any): void {
    ...
    this.readFileAsString(file!).then(
      ...
      (error) => {
        this.handleError("The image has not been loaded" + error);
      }
    )
  }
  ...
  private initializeItem(): void { this.item = new Item(undefined, "", 0); }

  private handleError(err: any): void { console.log(err); }
}
